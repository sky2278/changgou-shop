...
//             $("#seckill").append(
//                 "<li class='seckill-items'><div class='pic' ><img src='" + list["img"] + "' alt=''></div><div class='intro'><span>" + list["desc"] + "</span></div>"
...
//                 + "</div>"
//                 + "<a class='sui-btn btn-block btn-buy' href='seckill-items.html' target='_blank'>立即抢购</a>"
//                 + "</li >"
//             );
