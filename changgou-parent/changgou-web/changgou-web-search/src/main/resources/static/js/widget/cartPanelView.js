var cartPanelView = {
    ...
    setup : function (callback) {
        ...
        $('.tbar-cart-items').hover(function (){ $(this).find('.p-del').show(); },function(){ $(this).find('.p-del').hide(); });
        $('.jth-items').hover(function (){ $(this).find('.add-cart-button').show(); },function(){ $(this).find('.add-cart-button').hide(); });
        ...
        cartPanelView.cartCellTemplate = $("#tbar-cart-items-template").html();
