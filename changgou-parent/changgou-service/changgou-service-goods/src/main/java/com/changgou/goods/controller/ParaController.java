...
public class ParaController {
    ...
    /**
     * 根据categoryId获取模板对应的参数列表数据
     */
    @GetMapping("/findParasByCategoryId/{categoryId}")
    public Result<List<Para>> findParasByCategoryId(@PathVariable(value = "categoryId") Integer categoryId) {
        List<Para> paraList = paraService.findParasByCategoryId(categoryId);
        return new Result<>(true, StatusCode.OK, "根据categoryId获取模板对应的参数列表数据成功!", paraList);
    }
