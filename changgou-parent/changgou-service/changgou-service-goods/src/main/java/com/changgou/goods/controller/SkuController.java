...
public class SkuController {
    ...
    public void decrease(@PathVariable(value = "username") String username) {
        skuService.decrease(username);
        //return new Result(true, StatusCode.OK, "扣减库存信息成功!");
    }
    ...
    public List<Sku> findSkuBySpuId(@PathVariable(value = "spuId") Long spuId) {
        List<Sku> list = skuService.findSkuBySpuId(spuId);
        return list;
    }
