...
public class SpecController {
    ...
    public Result<List<Spec>> findSpecsByCategoryId(@PathVariable(value = "categoryId") Integer categoryId) {
        List<Spec> specList = specService.findSpecsByCategoryId(categoryId);
        return new Result<>(true, StatusCode.OK, "根据分类ID查询规格列表成功!", specList);
    }
