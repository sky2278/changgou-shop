...
public class UserController {
    ...
    public void increase(@PathVariable(value = "username") String username, @PathVariable(value = "points") Integer points) {
        userService.increase(username,points);
    }
     ...
     */
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('admin')")   //  设置权限信息
