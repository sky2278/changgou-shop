...
public class ContentController {
    ...
    public Result<List<Content>> findContentListByCategoryId(@PathVariable(value = "categoryId") Long categoryId) {
        List<Content> list = contentService.findContentListByCategoryId(categoryId);
        return new Result<>(true, StatusCode.OK, "接口调用成功!", list);
    }
