...
public class SeckillOrderController {
    ...
    public Result queryStatus() {
        ...
        if (seckillStatus == null) {
            return new Result(false, StatusCode.ERROR, "此用户暂无下单信息!");
        }
        return new Result(true, StatusCode.OK, "查询用户订单状态成功!", seckillStatus);
    }
     ...
     */
    @RequestMapping("/add")
    public Result add(String key, Long id) {
        String username = "zhangsan";
        Boolean bool = seckillOrderService.add(key, id, username);
        if (bool) {
